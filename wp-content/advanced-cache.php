...
$nitropack_functions_file = '/home2/lukesixt/public_html/wp-content/plugins/nitropack/functions.php';
$nitropack_abspath = '/home2/lukesixt/public_html/';
...
if (file_exists($nitropack_functions_file) && ABSPATH == $nitropack_abspath) {
    ...
    define( 'NITROPACK_ADVANCED_CACHE_VERSION', '1.5.19');
    define( 'NITROPACK_LOGGED_IN_COOKIE', 'wordpress_logged_in_a3146d91a900cfc270ba0e0b519625a0' );
