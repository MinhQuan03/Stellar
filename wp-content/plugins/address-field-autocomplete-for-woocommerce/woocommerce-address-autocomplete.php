...
class WC_Map_Checkout {
	...
	public function woocommerce_require_activation() {
		...
		echo '<div class="error"><p>' . sprintf( esc_html__( 'You have not activated the base plugin %s. Please activate it to use wc map checkout plugin.', 'address-autocomplete' ), '<b>Woocommerce</b>' ) . '</p></div>';
	}
